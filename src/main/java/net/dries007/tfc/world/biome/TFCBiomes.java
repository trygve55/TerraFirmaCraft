...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension SHORE = register("shore", builder().heightmap(BiomeNoise::shore).surface(ShoreAndOceanSurfaceBuilder.SANDY).aquiferHeightOffset(-16).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.WIDE).noSandyRiverShores().type(ShoreBlendType.SANDY).setShoreBaseHeight(-4));
    public static final BiomeExtension TIDAL_FLATS = register("tidal_flats", builder().heightmap(BiomeNoise::shore).surface(ShoreAndOceanSurfaceBuilder.SANDY).aquiferHeightOffset(-16).type(BiomeBlendType.OCEAN).salty().shore().type(RiverBlendType.WIDE).noSandyRiverShores().type(ShoreBlendType.SANDY).setShoreBaseHeight(-4));

    // Inspired by Bay of Fundy, 12 Apostles, etc. -- High biome shore
    public static final BiomeExtension SEA_STACKS = register("sea_stacks", builder().heightmap(seed -> BiomeNoise.hills(seed, 10, 30)).surface(ShoreAndOceanSurfaceBuilder.SEA_CLIFFS).aquiferHeightOffset(-40).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.TALL_CANYON).noSandyRiverShores().type(ShoreBlendType.SEA_STACKS).setShoreBaseHeight(-6));
    ...
    public static final BiomeExtension SETBACK_CLIFFS = register("setback_cliffs", builder().heightmap(seed -> BiomeNoise.hills(seed, 20, 30)).surface(ShoreAndOceanSurfaceBuilder.SANDY).aquiferHeightOffset(-40).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.CANYON).noSandyRiverShores().type(ShoreBlendType.SETBACK_CLIFFS));
    // Vegetated coastal Dunes -- Below setback cliffs
    public static final BiomeExtension COASTAL_DUNES = register("coastal_dunes", builder().heightmap(seed -> BiomeNoise.constant(0)).surface(ShoreAndOceanSurfaceBuilder.SANDY).aquiferHeightOffset(-40).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.WIDE_DEEP).noSandyRiverShores().type(ShoreBlendType.DUNES));

    // Chaotic rock formations, tide pools, and blowholes
    public static final BiomeExtension ROCKY_SHORES = register("rocky_shores", builder().heightmap(seed -> BiomeNoise.constant(-15)).surface(ShoreAndOceanSurfaceBuilder.ROCKY_SHORE).aquiferHeightOffset(-40).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.CANYON).noSandyRiverShores().type(ShoreBlendType.ROCKY_SHORES));

    // Similar Rocky Shores, but with beaches mixed in
    public static final BiomeExtension EMBAYMENTS = register("embayments", builder().heightmap(BiomeNoise::shore).surface(ShoreAndOceanSurfaceBuilder.SEA_CLIFFS).aquiferHeightOffset(-40).type(BiomeBlendType.LAND).salty().shore().type(RiverBlendType.CANYON).noSandyRiverShores().type(ShoreBlendType.EMBAYMENTS)); //
    ...
    public static final BiomeExtension SUNKEN_SHIELD_VOLCANO = register("sunken_shield_volcano", builder().heightmap(seed -> BiomeNoise.sunkenShieldVolcano(seed, BiomeNoise.ancientHotSpots(seed))).surface(ShieldVolcanoSurfaceBuilder.DORMANT).tuffRings(1f / 2f, -8, 24).aquiferHeightOffset(-16).spawnable().salty().noRivers().type(RiverBlendType.CAVE));
